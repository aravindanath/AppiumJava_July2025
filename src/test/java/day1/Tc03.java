...
public class Tc03 extends BaseTestUsingOptions{
    ...
    public void testCase01() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.androidUIAutomator(
                "new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text(\"Jordan Lift Off\"))")).click();

        Thread.sleep(2000);

        driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.androidsample.generalstore:id/productName\" and @text=\"Jordan Lift Off\"]//following-sibling::android.widget.LinearLayout[2]/android.widget.TextView[2][@text='ADD TO CART']")).click();
